...
%             plot(ExpCTL.timePost(1:1:60)-min(ExpCTL.timeWN)-1,median(ExpCTL.pitchPost(w1,1:1:60))-mnpre,'.')
            ...
            plot([runningaverage(ExpAPV.timeACpre(:),15)-min(ExpAPV.timeAPVwn)+3 runningaverage(ExpAPV.timeAPVwn(:),15)-min(ExpAPV.timeAPVwn) ],...
                [runningaverage(median(ExpAPV.pitchACpre(w1,:))-mnpre,15) runningaverage(median(ExpAPV.pitchAPVwn(w1,:))-mnapv,15) ])
         plot(runningaverage(ExpAPV.timeAPVwn(:),15)-min(ExpAPV.timeAPVwn),runningaverage(median(ExpAPV.pitchAPVwn(w1,:))-mnapv,15),'r')
         plot(runningaverage(ExpAPV.timeACpost(1:160),50)-min(ExpAPV.timeAPVwn)-12,runningaverage(median(ExpAPV.pitchACpost(w1,1:160))-mnpre,50),'b')
         ylim([-100 150])
ylim([-50 60])
