function [fvals,FFstats,avg,toffset,pitch]=summary_statsJC9(templa,batch,batchnote,cntrng)
fs=32000;
fvals=findwnoteJC(batchnote,'a','','',0,[2000 2800],8500,1,'obs0',1);
...
[pitch,avg]=jc_pitchmat1024(shifted,1024,1020,2,2000,2800,[1],'obs0',1);
