...
%temptest_aug21
%temptest
avls.pvls{1}='0911_ap5/'
avls.cvl{1}='batch'
avls.NT{1}='k'

avls.pvls{2}='0914_acsf/'
avls.cvl{2}='batch.catch'
avls.NT{2}='k'

avls.pvls{3}='0915_ap5_5mm'
avls.cvl{3}='batch.catch'
avls.NT{3}='k'

avls.pvls{4}='0913_wnon'
avls.cvl{4}='batch.catch.end'
avls.NT{4}='k'

avls.pvls{5}='912_wnoff'
avls.cvl{5}='batch.catch.keep'
avls.NT{5}='k'

avls.pvls{1}='0910_acsf'
