function [fvals,FFstats,avg,toffset,pitch]=summary_statsW(templa,batch,batchnote,cntrng)
fs=32000;
fvals=findwnote4(batchnote,'a','','',0,[2000 2700],8500,1,'w');
mk_tempf(batch,templa,2,'w');
