...
templa=mean(avna(1:2:256,[60:66]),2);
...
%check out template
uievtafsim('batchTEMPtest',templa);
...
mk_tempf('batchTEMPtest',templa,2,'obs0');
...
get_trigt('batchTEMPtest',cntrng,0.5,128,1,0);
...
cntrng(1).TH=2.5;
get_trigt('batchTEMPtest',cntrng,0.3,128,1,1);
[vals,trigs]=triglabel('batchTEMPtest','a',1,1,0,1);
...
wrt_templ('bk20bk45DOWN2.dat',tmpcomb);
