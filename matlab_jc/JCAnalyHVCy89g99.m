...
a=1;folders{a}=[basedir 'y89g99_111709_20/Directed'];clusters{a}=[2];prefixes{a}='Chan3_';
a=2;folders{a}=[basedir 'y89g99_111709_20/UnDirected'];clusters{a}=[2];prefixes{a}='Chan3_';




isDirected=1; % for directed
[Dneuron]=HVCprocessing_y89g99(folders,clusters,prefixes,isDirected);
isDirected=0; % for directed
[UDneuron]=HVCprocessing_y89g99(folders,clusters,prefixes,isDirected);
...
load /cardinal/HVCAnalysedData/UDsaved_y89g99.mat
clearvars -except UDneuron folders clusters prefixes
load /cardinal/HVCAnalysedData/Dsaved_y89g99.mat
...
harmwin=[130 140;185 200;110 150;30 40];
...
% Model 1: total number of spikes
    ...
    outvarsUD_model1=analyzeHVCallspikes2(ALLneuron,clusters,wins,harmwin,[2],1);
    outvarsD_model1=analyzeHVCallspikes2(ALLneuron,clusters,wins,harmwin,[1],1);    
