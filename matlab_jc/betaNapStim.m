...
for i=1:length(ExpJC)
    ...
    plot(runningaverage(performance(indFB,1),win),runningaverage(performance(indFB,3),win),'r')
    plot(runningaverage(performance(indCT,1),win),runningaverage(performance(indCT,3),win),'b')
end
