function [fvalsstr,pitch_data]=jc_PitchData717cbin(N,OVERLAP,sigma,F_low,F_high,batchFWN,noteFWN,prenoteFWN,postnoteFWN)
...
for found_note=1:length(fvalsstr)
    ...
    chopped_note=current_note(1:5500);
    [sonogram]=sonodv(chopped_note,SAMPLING,N,OVERLAP,sigma); 
    ...
    highest_harmonic=3; %round(a(1)/mini)-1;  %This often throws away the last one, but who cares
