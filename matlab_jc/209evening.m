% Method 4: 
BFkeep=[1 2 3 4 9];
for k=1:length(BFkeep)
    i=BFkeep(k);
    gpostBF(k)=(median(std(residuals(BFLesion(i).UDpost20_1024(ind1BF(k):ind1BF(k)+199,:)))./abs(mean(residuals(BFLesion(i).UDpost20_1024(ind1BF(k):ind1BF(k)+199,:))))));
    gpreBF(k)=(median(std(residuals(BFLesion(i).UDpre20_1024(ind1BF(k):ind1BF(k)+199,:)))./abs(mean(residuals(BFLesion(i).UDpre20_1024(ind1BF(k):ind1BF(k)+199,:))))));
end



% xcorr for adjacent renditions of the same note
for i=1:11;
g=xcorr(mean(residuals(ZFLesion(i).UDpre20_1024(ind1ZF(i)-150:ind1ZF(i)+150,1:20))));
gp=xcorr(mean(residuals(ZFLesion(i).UDpost20_1024(ind1ZF(i)-150:ind1ZF(i)+150,1:20))));
gnorm=g(20:30)./max(g(20:30));
gpnorm=gp(20:30)./max(gp(20:30));
hold on;plot(gnorm,'k');hold on;plot(gpnorm,'y')
end

% xcorr for different notes in the same motif
%pu24w55

    a=corrcoef(mean(pitch7pre(ind1ZF(7)-100:ind1ZF(7)+100,:)),mean(pitch8pre(ind1ZF(8)-100:ind1ZF(8)+100,:)));
    cpre(1)=a(2);
    a=corrcoef(mean(pitch8pre(ind1ZF(8)-100:ind1ZF(8)+100,:)),mean(pitch9pre(ind1ZF(9)-100:ind1ZF(9)+100,:)));
    cpre(2)=a(2);
    a=corrcoef(mean(pitch9pre(ind1ZF(9)-100:ind1ZF(9)+100,:)),mean(pitch10pre(ind1ZF(10)-100:ind1ZF(10)+100,:)));
    cpre(3)=a(2);
    a=corrcoef(mean(pitch7post(ind1ZF(7)-100:ind1ZF(7)+100,:)),mean(pitch8post(ind1ZF(8)-100:ind1ZF(8)+100,:)));
    cpost(1)=a(2);
    a=corrcoef(mean(pitch8post(ind1ZF(8)-100:ind1ZF(8)+100,:)),mean(pitch9post(ind1ZF(9)-100:ind1ZF(9)+100,:)));
    cpost(2)=a(2);
    a=corrcoef(mean(pitch9post(ind1ZF(9)-100:ind1ZF(9)+100,:)),mean(pitch10post(ind1ZF(10)-100:ind1ZF(10)+100,:)));
    cpost(3)=a(2);
%pu92w89
    a=corrcoef(mean(ZFLesion(3).UDpre20_1024(ind1ZF(3)-100:ind1ZF(3)+100,:)),mean(ZFLesion(4).UDpre20_1024(ind1ZF(4)-100:ind1ZF(4)+100,:)));
    cpre1(1)=a(2);
    a=corrcoef(mean(ZFLesion(4).UDpre20_1024(ind1ZF(4)-100:ind1ZF(4)+100,:)),mean(ZFLesion(5).UDpre20_1024(ind1ZF(5)-100:ind1ZF(5)+100,:)));
    cpre1(2)=a(2);
    a=corrcoef(mean(ZFLesion(5).UDpre20_1024(ind1ZF(5)-100:ind1ZF(5)+100,:)),mean(ZFLesion(6).UDpre20_1024(ind1ZF(6)-100:ind1ZF(6)+100,:)));
    cpre1(3)=a(2);
    a=corrcoef(mean(ZFLesion(3).UDpost20_1024(ind1ZF(3)-100:ind1ZF(3)+100,:)),mean(ZFLesion(4).UDpost20_1024(ind1ZF(4)-100:ind1ZF(4)+100,:)));
    cpost1(1)=a(2);
    a=corrcoef(mean(ZFLesion(4).UDpost20_1024(ind1ZF(4)-100:ind1ZF(4)+100,:)),mean(ZFLesion(5).UDpost20_1024(ind1ZF(5)-100:ind1ZF(5)+100,:)));
    cpost1(2)=a(2);
    a=corrcoef(mean(ZFLesion(5).UDpost20_1024(ind1ZF(5)-100:ind1ZF(5)+100,:)),mean(ZFLesion(6).UDpost20_1024(ind1ZF(6)-100:ind1ZF(6)+100,:)));
    cpost1(3)=a(2);
