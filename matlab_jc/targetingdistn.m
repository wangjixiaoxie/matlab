function [mediantargeting,targetdistn]=targetingdistn(Alldata,shiftedmethod,prctile_cutoff,tmp_cutoff,notesizeshiftms)

%%%%% Returns the distribution of targeting points (and the median as
%%%%% proportion of the note length) that are during the shifting period
%%%%% and not during inactivations --- this turns out to be an important
%%%%% distinction.
...
for i=1:length(Alldata)
    ...
    targetdistn(i).data=toffsets;
    mediantargeting(i)=(median(toffsets-16)-ons)/(offs-ons); 
end
