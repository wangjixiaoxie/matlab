function totals=WaveletAnalysis2(norm_resids_chopped,g)
...
qmf=g; %MakeONFilter('Symmlet',4); % The wavelet - I could try different ones.
for i=1:notes
    ...
    for j=1:steps
        ...
        returnee=PlotWaveCoeff3(wc,1,0);
