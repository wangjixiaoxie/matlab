function [fvals,FFstats,avg,toffset,pitch]=summary_statsNC(templa,batch,batchnote,cntrng)
fs=32000;
...
[pitch,avg]=jc_pitchmat1024(shifted,1024,1020,1,1950,2600,[3 ],'obs0',1);
