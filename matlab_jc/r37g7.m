...
% 10.05 - 35-45% B (b/(a+b+d))
% 10.06 - wn on B at dawn
    % ~35% B for the morning
    % evening - any learning? - increase catch trial ratio to 0.5 at 7pm
    % no noticeable learning
...
figure;hold on;
plot(tv424apvC(1:3:76),pitch424apvC(210,1:3:76),'*','Color','r')
...
plot(timing3(fvals425C(1:3:205)),pitch425C(210,1:3:205),'*','Color','k')
