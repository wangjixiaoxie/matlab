figure;plot(std(BFLesion(1).UDpre20_512'))
hold on;plot(std(BFLesion(1).UDpost20_512'),'r')
for j=1:length(BFLesion)
    for i=1:size(BFLesion(j).UDpre20_512,1)-280
        centeringBF(j).cvvals(i,:)=mean(std(BFLesion(j).UDpost20_512(i:i+279,:)'))+mean(std(BFLesion(j).UDpre20_512(i:i+279,:)'));
    end
...
for j=1:length(BFLesion)
    CVpreBF(j)=mean(std(BFLesion(j).UDpre20_512(ind1BF(j):ind2BF(j),:)'));
    CVpostBF(j)=mean(std(BFLesion(j).UDpost20_512(ind1BF(j):ind2BF(j),:)'));
end
...
for k=1:length(successesBF)
    i=successesBF(k);
    [xB,psdsPREBF(i).data]=jcpsd2(AlldataBFlesion(i).pitchUDpre(ind1BF(i):ind2BF(i),:),8000);
    [xB,psdsPOSTBF(i).data]=jcpsd2(AlldataBFlesion(i).pitchUDpost(ind1BF(i):ind2BF(i),:),8000);
end

for k=1:length(successesBF)
    i=successesBF(k);
    [xB20,psdsPREBF20ms(i).data]=jcpsd2(AlldataBFlesion(i).pitchUDpre(ind1BF(i)+60:ind1BF(i)+219,:),8000);
    [xB20,psdsPOSTBF20ms(i).data]=jcpsd2(AlldataBFlesion(i).pitchUDpost(ind1BF(i)+60:ind1BF(i)+219,:),8000);
end
