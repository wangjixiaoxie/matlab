function [ifdgram]=ifdvNS(s,SAMPLING,N,OVERLAP,sigma,ZOOMT,ZOOMF)

% This is my version which is NOT SPARSE (NS)
...
q=specgram(s,N,[],w,OVERLAP); %gaussian windowed spectrogram
q2=specgram(s,N,[],dw,OVERLAP); %deriv gaussian windowed spectrogram
%%% I added this code to avoid any q=0 happening
    [ind1,ind2]=find(q==0);
    q(ind1,ind2)=eps;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
