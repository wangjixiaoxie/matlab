function [pitch_data,ifd,sono,med]=jc_PitchData606p3(N,OVERLAP,sigma,F_low,F_high,data)
...
for found_note=1:1 %length(fvalsstr)
    ...
    [ifdgram,sonogram,med]=ifdvCONplot1(data,SAMPLING,N,OVERLAP,sigma,ZOOMT,ZOOMF,TL,FL); 
