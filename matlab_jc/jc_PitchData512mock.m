function [fvalsstr,pitch_data,ifd,sono]=jc_PitchData512mock(N,OVERLAP,sigma,F_low,F_high,batchFWN,noteFWN,prenoteFWN,postnoteFWN)
...
for found_note=1:length(fvalsstr)
    ...
    chopped_note=current_note(6000:8000);
