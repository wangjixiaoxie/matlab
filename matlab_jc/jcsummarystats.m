function [fvals,FFstats,avg,toffset,pitch]=summary_stats2(templa,batch,batchnote,cntrng)
fs=32000;
...
for i=1:length(fvalsT)
    shiftedT(i,:)=fvalsT(i).datt;
end
[pitchT,avgT]=jc_pitchmat1024(shiftedT,1024,1020,1,1950,2600,[1 2 3],'obs0',1);
