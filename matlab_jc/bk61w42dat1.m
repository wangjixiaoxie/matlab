...
%%%TKTK
edges{1}=[6600:55:7700]
edges{2}=[3000:60:4000]
edges{3}=[3000:60:4000]
...
catchvl{16}='batch07.keep.rand';tmn{16}=['7'];tmf{16}=['9:45'];
...
catchvl{21}='batch';tmn{21}=['13:29'];tmf{21}=['21'];
...
acon=[ 1 3 4 6 7 9 10 12 13 15 16 18 19 21 22 24 25 27] ;  
muon=[2 5 8 11 14 17 20 23 26]
revanal{1}{1}=[];
muanal{1}{1}=[2 5 8 11 14 17 20 23 26]
