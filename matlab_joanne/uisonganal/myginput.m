function [out1,out2,out3] = myginput(arg1,varargin)

% Same as matlab ginput but accepts input with respect to a user specified
% axis and allows the second mouse button (or return key press) to terminate.
%
...
%   $Revision: 1.2 $  $Date: 2002/09/11 09:28:32 $
...
if ~strcmp(tp,'none') & ~strcmp(tp,'x') & ~strcmp(tp,'micro'),
  ...
  while how_many ~= 0
	...
	pt = get(gca, 'CurrentPoint');
      ...
      if(char == 13 | button == 2) % & how_many ~= 0)
