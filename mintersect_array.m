function [runIntersect, output_indices] = mintersect_array(varargin)
% MODIFIED BY LT 3/14/14 to take one cell array containing cells e,g,
% {{'a','b'},{'b','c'}) as input (original fcn took multiple arguments, one
% for each array). Also put output indices so that I do not have to
% specify one output var for each indices I want.  All will be in one
% array.
