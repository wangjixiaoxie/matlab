function [amplifier_data,board_dig_in_data,frequency_parameters, board_adc_data, board_adc_channels, amplifier_channels, board_dig_in_channels] = pj_readIntanNoGui(file)
