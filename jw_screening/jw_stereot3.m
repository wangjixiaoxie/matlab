function [lin,scon,st,lcon,entr]=jw_stereot3(batch,condition,INTRO)
% [lin,scon,st,lcon,entr]=jw_stereot3(batch,condition,intro)
%
%unlike stereot2, this treats repeat trains as single syls.
%also, one .not.mat in the batchfile is omitted randomly each time
%
