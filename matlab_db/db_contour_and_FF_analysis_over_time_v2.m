...
song_folders = db_list_song_folders(multiple_pitch.parameters.phrase, omit,...
    [multiple_pitch.parameters.computer '/' multiple_pitch.parameters.nameofbird]);
fid = fopen([multiple_pitch.parameters.computer '/' multiple_pitch.parameters.nameofbird ...
...
for i = 1:length(multiple_pitch.parameters.syllables)
    for j = multiple_pitch.parameters.days{3}:multiple_pitch.parameters.days{4}
        ...
        try
            cd([multiple_pitch.parameters.computer '/' multiple_pitch.parameters.nameofbird '/' folders{1}{j-multiple_pitch.parameters.days{3}+1}])
            try
            ...
            cd([multiple_pitch.parameters.computer '/' multiple_pitch.parameters.nameofbird ])
        catch err
...
save([multiple_pitch.parameters.computer '/' multiple_pitch.parameters.nameofbird '/' multiple_pitch.parameters.nameofbird '_' ...
