...
wiener_entropy.parameters.computer = ['/bluejay' num2str(which_computer) '/dbrady'];
...
for i = 1:length(wiener_entropy.parameters.syllables)
    for j = wiener_entropy.parameters.days{3}:wiener_entropy.parameters.days{4}
        ...
        try
            ...
            cd([wiener_entropy.parameters.computer '/' wiener_entropy.parameters.nameofbird '/all_calls'])
        catch err
