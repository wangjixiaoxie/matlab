...
%asks for phrase
multiple_pitch.parameters.phrase = input('Pharse? ','s');
...
try
    load([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' multiple_pitch.parameters.phrase '/' mult_FF_boot.parameters.birdname '.mat'])
catch err
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/bootstrap_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/bootstrap_figures'])
else
end
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/percent_change_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/percent_change_figures'])
else
end
...
for i = 1:length(multiple_pitch.parameters.syllables)
    for j = 1:length(mult_FF_boot.parameters.names_parameters)
        ...
        %save figures
        saveas(figure(gcf),[mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
            mult_FF_boot.parameters.birdname '/percent_change_figures/Percent_change_' ...
            strrep(mult_FF_boot.parameters.names_parameters{j},' ','_') '_for_' multiple_pitch.parameters.syllables(i) ...
            '_for_' mult_FF_boot.parameters.birdname], 'fig')
    end
end
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/change_from_baseline_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/change_from_baseline_figures'])
else
end
...
for i = 1:length(multiple_pitch.parameters.syllables)
    for j = 1:length(mult_FF_boot.parameters.names_parameters)
        ...
        %save figures
        saveas(figure(gcf),[mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
            mult_FF_boot.parameters.birdname...
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/correlation_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/correlation_figures'])
else
end
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/z_score_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '/z_score_figures'])
else
end
