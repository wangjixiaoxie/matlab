...
check_pitch.parameters.computer = ['/bluejay' num2str(which_computer) '/dbrady/'];
...
%                 cntrng(kk).MODE=1;
%                 cntrng(kk).MIN=syllables.(sofinterest{i}).parameters.cntrng_values{kk}(1);
%                 cntrng(kk).MAX=syllables.(sofinterest{i}).parameters.cntrng_values{kk}(2);
%                 cntrng(kk).TH=syllables.(sofinterest{i}).parameters.cntrng_values{kk}(3);
%                 
...
%                 cntrng(kk).MIN=syllables.(sofinterest{i}).parameters.birdtaf_values{kk}(1);
%                 cntrng(kk).MAX=syllables.(sofinterest{i}).parameters.birdtaf_values{kk}(2);
%                 cntrng(kk).TH=syllables.(sofinterest{i}).parameters.birdtaf_values{kk}(3);
%                 
...
%% Calculating hit rate (using ADDX = 0), offline
    ...
    [syllables.(check_pitch.parameters.sofinterest{i}).hit.values syllables.(check_pitch.parameters.sofinterest{i}).hit.trigger] = triglabel(check_pitch.parameters.batchfile,check_pitch.parameters.sofinterest{i},1,1,0,0);
...
%% Calculating template matching and timing (using ADDX = 1), online
    ...
    [syllables.(check_pitch.parameters.sofinterest{i}).match.values syllables.(check_pitch.parameters.sofinterest{i}).match.trigger] = triglabel(check_pitch.parameters.batchfile,check_pitch.parameters.sofinterest{i},1,1,0,1);
