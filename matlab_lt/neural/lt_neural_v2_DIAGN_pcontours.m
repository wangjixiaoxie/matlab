function lt_neural_v2_DIAGN_pcontours(SummaryStruct, useDiffColors, plotbysyl, ...
    dolinkaxes)
...
elseif plotbysyl==1
    ...
    % IN PROGRESS - NEED TO EXTRACT ALL UNIQUE SYLS ACROSS NEURONS BEFORE
    % CAN ITERATE OVER THOSE SYLS...
