...
%                         Y = FF - mean(FF);
                        ...
                        if plotRaw==1
                            ...
                            title(motifstr);
                            ylabel('FF');
                            xlabel(['n' num2str(neurons_thisset(nn)) '-' brainRegions{nn}]);
                            lt_regress(Y, X(:,1), 1);
                            lt_plot_zeroline;
                            ...
                            title(motifstr);
                            ylabel('FF');
                            xlabel(['n' num2str(neurons_thisset(nnn)) '-' brainRegions{nnn}]);
                            lt_regress(Y, X(:,2), 1);
                            lt_plot_zeroline;
                            lt_plot_zeroline_vert
                            ...
                            %
                            %                         xlabel(['n' num2str(neurons_thisset(nn)) '-' brainRegions{nn}]);
                            %                         ylabel(['n' num2str(neurons_thisset(nnn)) '-' brainRegions{nnn}]);
                            %                         zlabel('FF');
                            %                         lt_plot_zeroline;
                            %                             lt_plot_zeroline_vert;
                        end
