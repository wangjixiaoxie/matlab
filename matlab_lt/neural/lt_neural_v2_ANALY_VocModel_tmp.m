function lt_neural_v2_ANALY_VocModel(SummaryStruct, Binparams, plotRaw, ConvOrDiv)
...
mindattoplot = 1; % min N for a given category.
...
%% ========================= GLM
% things to do:
% 1) check residuals (overdispersion?)
% quasipoisson or negative binomial?
% compare fit to classical regression
