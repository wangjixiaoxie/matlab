...
%% lt 11/8/17 - looks at pairwise correlations between neurons (spike count corr), changes dur learning
%% note: only works if all neurons have matched song files (i.e. same batch file)
%%
plotFFbyRend=0;
        ...
        for iii=1:numswitches
            ...
            for j=motifstoplot
                ...
                for nn=goodneurons
                    ...
                    if plotFFbyRend==1
                        plot(ffvals, 1:length(ffvals), 'xr');
                    else
                        plot(ffvals, tvals, 'xr');
                    end
