...
%                     'rs'}; % OLD VERSION -                     
            ...
            elseif strcmp(birdname, 'br92br54')
                if strcmp(exptname, 'LMANlearn2') | strcmp(exptname, 'LMANlearn4')
                    MotifsActual = {'ddd', 'ddd(h)', 'agcc', 'nkh'}; % IMPROVE - NEED TO ADD THINGS (E.G. []d)
...
%                         'gvb', 'gh', 'gbb', 'yoo', 'opt'}; % OLD VERSION, GOT TOO MESSY
                MotifsActual = {'nhh', 'j(k)', 'jk(k)', 'kl', 'y(o)', 'yo(o)', 'we', ...
                        ...
                        'hh(r)', 'p(r)', 'l(r)', ...u
                        'r(s)', 'h(s)', ...
                        'r(g)', 'b(g)', 'l(g)', 's(g)', 'p(g)', 'h(g)', 'v(g)', ...
                        'g(v)', 'u(v)', 't(v)', ...
                        'gv(b)', 'gvb(b)', 'g(b)', 'gb(b)', 'm(b)', ...
                        'o(t)', 's(t)', ...
                        'v(m)', ...
                        'e(u)'}; 
