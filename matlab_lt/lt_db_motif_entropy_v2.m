...
% NOTE (LT) - 1/16) -REGARDING changes made on 12/02 - those are not
% necessary.  the pre and post time are only for extracting spectrogram,
% they do not affect the windows used for entropy calcs.
