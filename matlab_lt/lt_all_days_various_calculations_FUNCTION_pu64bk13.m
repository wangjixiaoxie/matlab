...
%% LT 1/5/15 - pu64bk13 means using lt_compile_seq_dep_pitch_data_pu64bk13 - changed pre time to get more data (from -0.005 to -0.010)
...
%             end
            ...
            if strcmp(seq_dep_pitch,'y')==1;
                ...
                compiled_seqdep_pitch=lt_compile_seq_dep_pitch_data_pu64bk13(batchSDP, syllables_SDP, frequency_range_SDP, pc_window_SDP, ...
