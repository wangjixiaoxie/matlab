...
%% 1/13/14 - v2 = added ability to target syl within a motif (e.g. find 'ab' and change those b to c).
% v2 obsolete, use just db_change... and put motif in original syl and new
% motif in new_syl (i.e. o_s='ab', n_s='ac')
