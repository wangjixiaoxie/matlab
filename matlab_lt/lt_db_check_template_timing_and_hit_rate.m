%% LT - 7/22/14 - do no use. use lt_check_hit_templ_freq
...
%% Calculating template matching and timing (using ADDX = 1), online
    ...
    [syllables.(check_pitch.parameters.sofinterest{i}).match.values syllables.(check_pitch.parameters.sofinterest{i}).match.trigger] = triglabel(check_pitch.parameters.batchfile,check_pitch.parameters.sofinterest{i},1,0,0,1);
