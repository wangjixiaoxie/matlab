function [all_spectrograms,t,f,all_smoothed_waveforms]=lt_get_individual_avn(bt,NT,PRETIME,POSTTIME,PRENT,POSTNT,CS,PLTIT);
...
spcnt=0;
clear all_spectrograms
clear all_smoothed_waveforms
for ii=1:length(files)
	...
	if (length(pp)>0)
		...
		for jj=1:length(pp)
            ...
            all_spectrograms(:,:,spcnt+1)=abs(sp);
            all_smoothed_waveforms(:,spcnt+1)=sm;
