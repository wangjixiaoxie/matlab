function [SeqDepPitch_AcrossBirds, PARAMS]=lt_seq_dep_pitch_ACROSSBIRDS_DRIFT(SeqDepPitch_AcrossBirds, PARAMS)
%% LT 8/12/15 - Analyzes baseline drift for all experiments

NumBirds=length(SeqDepPitch_AcrossBirds.birds);

%% GET VARIOUS STATS ABOUT BASELINE FOR EACH SYLLABLE

syl_count=0;
BaselineStats=[]; % one for each syl.
for i=1:NumBirds;
