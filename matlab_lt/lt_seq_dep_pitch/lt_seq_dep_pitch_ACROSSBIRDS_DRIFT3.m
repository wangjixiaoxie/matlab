function lt_seq_dep_pitch_ACROSSBIRDS_DRIFT3(SeqDepPitch_AcrossBirds, PARAMS, WNdaynum_start, WNdaynum_end)
%% LT 9/24/15 - v3 is modified version of v2, 
...
%% ===== WARNING
disp('NOTE: this program different from v2 - here not accounting for lack of data on early WN days by adding more days, which I do in v2');
...
%         NumWNDays=Learning_day_inds(end)-WN_start_ind+1; % to end of epoch used to quantify learning
        ...
        % ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ v3 different (compared to v2)
        
        WN_start_ind=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_PlotLearning.Params.PlotLearning.WNTimeOnInd;
        Learning_day_inds=WN_start_ind+WNdaynum_start-1:WN_start_ind+WNdaynum_end-1;
        LearningWindow_days=length(Learning_day_inds);
        NumWNDays=Learning_day_inds(end)-WN_start_ind+1; % to end of epoch used to quantify learning
        ...
        if max(Learning_day_inds)>SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_PlotLearning.Params.PlotLearning.WNTimeOffInd;
            disp(' ');
            disp(['Threw out: ' birdname ' - ' exptname ', since not not enough WN days']);
            continue
        end        
...
%               TROUBLESHOOTING ONLY
            ...
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.Learning_start_inds=Learning_start_inds;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.Learning_end_inds=Learning_end_inds;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.Baseline_start_inds=Baseline_start_inds_Shared;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.Baseline_end_inds=Baseline_end_inds_Shared;
            
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.DATA.(syl).learning_start_ffvals=learning_start_ffvals;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.DATA.(syl).learning_end_ffvals=learning_end_ffvals;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.DATA.(syl).baseline_start_ffvals=baseline_start_ffvals;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.DATA.(syl).baseline_end_ffvals=baseline_end_ffvals;
           
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.ffmean_diff=mudiff_learning;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.dprime=dprime_learning;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.zscore=zscore_learning;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.p_ranksum=p_ranksum_learning;
            
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.ffmean_diff=mudiff_baseline;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.dprime=dprime_baseline;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.zscore=zscore_baseline;
            SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.p_ranksum=p_ranksum_baseline;
...
for i=1:NumBirds;
    ...
    for ii=1:numexperiments;
        ...
        if ~isfield(SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}, 'Data_DRIFT3');
        ...
        for j=1:length(syls_unique);
            ...
            % ====== dprime
            dprime_learning=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.dprime;
            dprime_base=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.dprime;
            
            % ===== pval (ranksum)
            pval_learn=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.p_ranksum;
            pval_base=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.p_ranksum;
            
           % ==== Pitch diff 
            ffdiff_learn=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).LEARNING.ffmean_diff;
            ffdiff_base=SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_DRIFT3.OneBaselineComparison_shared.STATS.(syl).BASELINE.ffmean_diff;
...
% ============== NOTE TO SELF
[fignums_alreadyused, hfigs, count]=lt_plot_MultSubplotsFigs(SubplotsPerFig, subplotrows, subplotcols, fignums_alreadyused, hfigs, count);
lt_plot_text(0, 0.5, 'NOTE TO SELF: If any sample has N=2');
lt_plot_text(0, 0.4, 'then might not plot correctly (but mean is fine)');
...
[fignums_alreadyused, hfigs, count]=lt_plot_MultSubplotsFigs(SubplotsPerFig, subplotrows, subplotcols, fignums_alreadyused, hfigs, count);
title('mean pitch diff[nontargs]');
xlabel('baseline - WN');
...
% 
% % NOTE: ALL BELOW PUT INTO SCRIPT ABOVE
% [fignums_alreadyused, hfigs, count]=lt_plot_MultSubplotsFigs(SubplotsPerFig, subplotrows, subplotcols, fignums_alreadyused, hfigs, count);
...
% [fignums_alreadyused, hfigs, count]=lt_plot_MultSubplotsFigs(SubplotsPerFig, subplotrows, subplotcols, fignums_alreadyused, hfigs, count);
% title('[nontargs]');
% xlabel('paired diff of abs pitch (learning - base)');
% grid on;
% 
% % --- flipped
...
% lt_plot_pvalue(p, 'two-sided sign rank(flipped)');
% 
% 
% % ======= 9c) CDF (paired diff)
% [fignums_alreadyused, hfigs, count]=lt_plot_MultSubplotsFigs(SubplotsPerFig, subplotrows, subplotcols, fignums_alreadyused, hfigs, count);
...
% lt_plot_pvalue(p, 'one-sided sign rank(abs)');
% 
% 
