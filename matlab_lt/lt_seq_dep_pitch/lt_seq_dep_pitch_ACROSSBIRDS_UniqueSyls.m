...
for j=1:NumBirds;
    birdname=SeqDepPitch_AcrossBirds.birds{j}.birdname;
    NumExperiments=length(SeqDepPitch_AcrossBirds.birds{j}.experiment);
    
    
    for jj=1:NumExperiments;
    exptname=SeqDepPitch_AcrossBirds.birds{j}.experiment{jj}.ExptID;
        ...
        % ====================================================
        % COMPARE TO THE SYLFIELDS IN PLOT LEARNING STRUCT
        if isfield(SeqDepPitch_AcrossBirds.birds{j}.experiment{jj}.Data_PlotLearning.Params.PlotLearning, 'SylFields_Unique');
            
            sylsOLD=SeqDepPitch_AcrossBirds.birds{j}.experiment{jj}.Data_PlotLearning.Params.PlotLearning.SylFields_Unique;
            sylsNEW=SylFields_Unique;
...
%% old version - exactly the same, except above displays comparison for cases where SylsUnique is already exists.
% for j=1:NumBirds;
%     NumExperiments=length(SeqDepPitch_AcrossBirds.birds{j}.experiment);
%     
%     for jj=1:NumExperiments;
