...
function [Params, AllDays_StructStatsStruct]=lt_seq_dep_pitch_StructureStats(Params, AllDays_RawDatStruct)
...
Params.StructureStats.savedir=[Params.SeqFilter.savedir '/StatsStruct_' tstamp];
mkdir(Params.StructureStats.savedir);

save([Params.StructureStats.savedir '/AllDays_StructStatsStruct.mat'],'AllDays_StructStatsStruct');
save([Params.StructureStats.savedir '/Params.mat'],'Params');
