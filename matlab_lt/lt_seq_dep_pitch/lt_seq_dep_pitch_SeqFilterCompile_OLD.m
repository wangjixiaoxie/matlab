...
%             PC_mat=cell2mat(AllDays_RawDatStruct{j}.data_WithOutlier.(syllables{i})(:,2)); % convert to mat
            ...
            for ii=1:num_columns; % for each column, perform check.
                ...
                % (based on pu37wh20)
                [~, B, C]=lt_db_tukey_outlier_90tile(PC_mat,columns_to_check(1)+ii-1,2);
...
% save
save([Params.SeqFilter.savedir '/AllDays_RawDatStruct.mat'],'AllDays_RawDatStruct','-v7.3');
save([Params.SeqFilter.savedir '/Params.mat'],'Params','-v7.3');
