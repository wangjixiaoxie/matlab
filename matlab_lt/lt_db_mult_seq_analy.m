%% LT 5/12/14 - added functions to automatically fill in stuff like bird name and date based on folder name
...
[birdname, which_computer, ddate, phrase]=lt_get_birdname_date_from_dir(1);
...
multiple_trans.parameters.bird_name = birdname;
multiple_trans.parameters.date_of_exp = ddate{2};
