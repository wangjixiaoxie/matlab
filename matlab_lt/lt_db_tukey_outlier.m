...
outlier_max = (median(matrix(:,which_column))+iqr(matrix(:,which_column))/2) + numIQR*iqr(matrix(:,which_column));

outlier_min = (median(matrix(:,which_column))-iqr(matrix(:,which_column))/2) - numIQR*iqr(matrix(:,which_column));
