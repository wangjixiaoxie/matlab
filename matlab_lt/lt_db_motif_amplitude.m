...
% LT modified 9/30/13 to use lt_bandpass instead of bandpass (line59)
% bandpass was giving me an error.
...
while ischar(next_line)
    ...
    waveform = lt_bandpass(raw_waveform,Fs,low_filter,high_filter);
