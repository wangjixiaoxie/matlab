...
% TO DO: separate into two diff functions. They will have different
% beginnings (making rec file) and same endings.
% Change ending to output repeats
% Add hits stats summary to end.
...
if get_offline_match==1;
    ...
    EvTAFv4Sim_LT(parameters.batchfile,config,'obs0') ;
