...
Params.PLOT_savedir='PLOT';
for i=1:length(Params.FieldsToCheck);
    Params.PLOT_savedir=[Params.PLOT_savedir '_' Params.FieldsToCheck{i}];
end
Params.PLOT_savedir=[Params.savefolder '/' Params.PLOT_savedir '_' tstamp];

mkdir(Params.PLOT_savedir);
cd(Params.PLOT_savedir);
