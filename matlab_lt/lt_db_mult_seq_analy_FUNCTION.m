...
function lt_db_mult_seq_analy_FUNCTION(bird_dir,bird_name,date_of_exp,phrase,batchfile,num_tp,tpofinterest,con_or_div)
...
multiple_trans.parameters.computer = bird_dir; %directory that contains bird folder (e.g./bluejay2/lucas/birds)
