...
avls.pvls{1}='wnon_acsf_702pm/'
avls.cvl{1}='batch.catchinit'
avls.NT{1}='a'

avls.pvls{2}='wnon_acsf_702pm/'
avls.cvl{2}='batch.catchfinal'
avls.NT{2}='a'
