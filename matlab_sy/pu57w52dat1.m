...
catchvl{19}='batch';tmn{19}=['7'];tmf{19}=['15:49'];
...
catchvl{27}='batch21.rand.keep';tmn{27}=['7'];tmf{27}=['21'];

pathvl{28}='/oriole5/pu57w52/219_ACSF/'
catchvl{28}='batch23.rand.keep';tmn{28}=['7'];tmf{28}=['21'];

pathvl{29}='/oriole5/pu57w52/223_ACSFnew/'
catchvl{29}='batch24.keep.rand';tmn{29}=['7'];tmf{29}=['9:54'];

pathvl{30}='/oriole5/pu57w52/224APVNEW/'
catchvl{30}='batch.catch.keep';tmn{30}=['9:54'];tmf{30}=['15'];

pathvl{31}='/oriole5/pu57w52/224APVNEW/'
catchvl{31}='batch.catch.end';tmn{31}=['15'];tmf{31}=['21'];

pathvl{32}='/oriole5/pu57w52/218wnoff/'
catchvl{32}='batch18.keep.rand';tmn{32}=['7'];tmf{32}=['21'];

pathvl{33}='/oriole5/pu57w52/wnon2909eve/'
catchvl{33}='batch10.catch.keep.rand';tmn{33}=['7'];tmf{33}=['21'];

pathvl{34}='/oriole5/pu57w52/wnon2909eve/'
catchvl{34}='batch11.catch.keep.rand';tmn{34}=['7'];tmf{34}=['21'];

pathvl{35}='/oriole5/pu57w52/219_ACSF/'
catchvl{35}='batch20.rand.keep';tmn{35}=['7'];tmf{35}=['21'];

pathvl{36}='/oriole5/pu57w52/219_ACSF/'
catchvl{36}='batch22.rand.keep.rand';tmn{36}=['7'];tmf{36}=['21'];

pathvl{37}='/oriole5/pu57w52/21409_ACSF/'
catchvl{37}='batch15.catch.keep';tmn{37}=['7'];tmf{37}=['21'];
...
acon=[ 1 3 5 6 7 8 10 12 13 15 16 18 19 21 22 24:29 31 32:37 ] ;  
muon=[2 4 9  11 14 17 20 23 30]
revanal{1}{1}=[];
revanal{1}{2}=[]
revanal{2}{1}=[]
revanal{2}{2}=[]
muanal{1}{1}=[2 4 9 11 14 17 20 23 30]
