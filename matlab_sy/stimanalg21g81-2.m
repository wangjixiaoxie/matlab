...
switchdt{1}='2007-01-30 12:00:00' %12:00:00'
switchdt{2}='2007-02-02 13:55:00' %13:55:00';
switchdt{3}='2007-02-05 16:35:00' %16:35:00';
switchdt{4}='2007-02-08 15:47:00' %20:00:00'
%
switchdt{5}='2007-02-13 13:35:00'  %13:35:00'
switchdt{6}='2007-02-15 19:00:00' %19:00:00'

dir=[1 1 1 1 0]
thresh=[3860 3860 3950 3775 3900] 
freqbnds=[3000 5000]
...
matrixvals=make_time_indices('2007-01-22','2007-03-07',7,21)
...
%subplot(4,1,1)
ax(1)=plot_conting(switchdts, vals(1,1), thresh, dir, freqbnds)
hold on;
%subplot(4,1,2:4)
errorbar(timevals, mnvl, stdv,'k+','Linewidth',3)
