...
%                     indvl2=sumbs.mulist(ind);
                    vls.acz(ii)=sumbs.acz(ind);
                    vls.acmean(ii)=sumbs.acmean(ind)/3000;
                    
%                     vls.aczerr(ii)=sumbs.acerrz(ind)
%                     vls.acstdv(ii)=sumbs.acstdv(ind)/3000;
                    vls.muz(ii)=sumbs.muz(ind);
                    vls.mumean(ii)=sumbs.mumean(ind)'/3000
%                     vls.muzerr(ii)=sumbs.muerrz(ind)
%                     vls.mustdv(ii)=sumbs.mustdv(ind)/3000;
                end
