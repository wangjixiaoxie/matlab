...
% --- Executes on button press in UseSpectBox.
function UseSpectBox_Callback(hObject, eventdata, handles)
% hObject    handle to UseSpectBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of UseSpectBox


% --- Executes on mouse motion over figure - except title and menu.
function EVSONGANAL_WindowButtonMotionFcn(hObject, eventdata, handles)
% hObject    handle to EVSONGANAL (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
return;
