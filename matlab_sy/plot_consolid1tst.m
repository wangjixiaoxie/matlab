...
function []=plot_consolid1(phsumbs,bs,sumbs)
figure

% figstoplot=[1 2 3 4 5  ]
% figstoplot=[5 6 7 ];
% figstoplot=[1 2 7 12]
figstoplot=[1 2 3 7 8 12 13]
...
%         axtmcourse(ii)=subplot(1,bsln,ii);
        plotrawlearning(avls,startind,endind);
%         axis square
        axis([ -3 9 2.2 2.8])
...
[outvlaczcomb,outvlmuzcomb]=plotcombdynamics2_stim(sumdyn,sumbs,ps)
hold on;
plot([-1 5],[0 0],'k--');
plot([-1 5],[3.5 3.5],'k--');
axis([0 9 -1 5])
...
% figure
[sumdyn,sumdynasymp,sumdynrev]=selectdynamicrunsstim2(sumbs,0,0,0)
[outvlaczcomb,outvlmuzcomb]=plotcombdynamics2_stim(sumdynasymp,sumbs,ps)
hold on;
plot([-1 5],[0 0],'k--');
plot([-1 5],[3.5 3.5],'k--');
axis([0 6 -1 5])
...
% figure
[phsumdyn,phsumdynasymp,phsumdynrev]=selectdynamicruns4(phsumbs,0,0,0)
[outvlaczcomb,outvlmuzcomb]=plotcombdynamics2_pharm(phsumdyn,phsumbs,ps)
hold on;
 plot([-1 5],[0 0],'k--');
plot([-1 5],[3.5 3.5],'k--');
axis([0 9 -1 5])
...
% figure
[phsumdyn,phsumdynasymp,phsumdynrev]=selectdynamicruns4(phsumbs,0,0,0)
[outvlaczcomb,outvlmuzcomb]=plotcombdynamics2_pharm(phsumdynasymp,phsumbs,ps)
hold on;
 plot([-1 5],[0 0],'k--');
plot([-1 5],[3.5 3.5],'k--');
axis([0 6 -1 5])
