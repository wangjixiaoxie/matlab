...
wnin(1).tmon{1}={'2009-7-15 7' '2009-7-18 7'}
wnin(1).tmon{2}={'2009-7-23 7' '2009-7-25 7'}  
wnin(1).tmoff{1}={'2009-7-18 7' '2009-7-19 7'}
...
avls.contfv=[]
avls.ptfv=[]
avls.analfv=[1 4 9:31]
avls.catchstimfv=[]
avls.STAN_RUNS=[1 4 9:19 21:28]
avls.contnum=3;
