...
% pathvl{2}='/doyale/twarren/r95pk42/r95pk42screen/'
% catchvl{2}='batch2.keep.rand'
pathvl{3}='/doyale/twarren/r95pk42/templteste2/';
catchvl{3}='batch1920comb'
pathvl{4}='/doyale/twarren/r95pk42/templteste3/'
catchvl{4}='batch.catch.keep'
pathvl{5}='/doya/r95pk42/wnon2/'
catchvl{5}='batch2223'
pathvl{6}='/doya/r95pk42/wnon2/'
catchvl{6}='batch24.catch.keep'
pathvl{7}=pathvl{6}
catchvl{7}='batch25.catch.keep'
pathvl{8}='/doyale/twarren/r95pk42/wnon3/'
catchvl{8}='batch26.keep.catch'
pathvl{9}='/doyale/twarren/r95pk42/wnon3/'
catchvl{9}='batch27.keep.catch.rand'
pathvl{10}=pathvl{9}
catchvl{10}='batch30.keep.catch'
pathvl{11}=pathvl{10}
catchvl{11}='batch31.keep.catch'
pathvl{12}=pathvl{11}
catchvl{12}='batch01.keep.catch'
pathvl{13}=pathvl{12}
catchvl{13}='batch02.keep.rand'
...
clear switchdts
bnds{1}='2007-04-22 07:00:00'
bnds{2}='2007-06-03 07:00:00'
switchdt{1}='2007-05-02 7:00:00' %12:00:00'
...
matrixvals=make_time_indices('2007-04-22','2007-06-03',7,21)
