...
pathvl{1}='/doyale4/twarren/pk72r70/preday/'
catchvl{1}='batch.keep.rand'
pathvl{2}='/doyale4/twarren/pk72r70/templtest1/'
catchvl{2}='batch.keep.rand'
pathvl{3}='/doyale4/twarren/pk72r70/templtest2/';
catchvl{3}='batch.keep.rand'
pathvl{4}='/doyale4/twarren/pk72r70/templtest3/'
catchvl{4}='batch.keep.rand'
pathvl{5}='/doyale4/twarren/pk72r70/templtest4/'
catchvl{5}='batch.keep.rand'
pathvl{6}='/doyale4/twarren/pk72r70/templtest5/'
catchvl{6}='batch.keep.rand'
pathvl{7}='/doyale4/twarren/pk72r70/templtest8/'
catchvl{7}='batch'

pathvl{8}='/doya4/pk72r70/wnon/'
catchvl{8}='batchcomb.keep.catch'
pathvl{9}='/doya2/pk72r70/wnoff/'
catchvl{9}='batchcomb.keep.catch'
