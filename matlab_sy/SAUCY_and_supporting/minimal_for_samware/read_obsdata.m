function [daqdata, ad_freq] = read_obsdata(filename, chan_spec)
...
%   [daqdata, ad_freq] = read_labv_file(filename, ch_num, direction);
%disp('HACK - using evsoundin.m instead of read_labv_file.m in cvs/read_obsdata.m')
   [daqdata, ad_freq] = evsoundin('.',filename, ['obs' chan_spec]);
