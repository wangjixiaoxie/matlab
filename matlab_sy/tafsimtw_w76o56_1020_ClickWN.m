...
[avnB,t,f]=get_avn('batch_1020clickWN','b',0.2,0.2,'','','obs0'); 
...
%check out template
uievtafsim('batch.catch',templaB);
...
mk_tempf('batch_1020clickWN',templaB,2,'obs0');
...
get_trigt2('batch_1020clickWN',cntrng,0.4,128,1,1); %0.4 = refractory period (sec)
...
[vals,trigs]=triglabel('batch.catch','b',1,1,0,1);
...
wrt_templ('w76o56_temp1020.dat',templaB);
