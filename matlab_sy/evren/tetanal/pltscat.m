...
if (~exist('CLUSTPLT'))
	...
	CURRCLUSTERBOX=uicontrol('Style','edit','Position',[410,YP,30,20],...
			'String','0');
    RECLUSTBTN=uicontrol('Style','pushbutton','Position',[450,YP,100,20],...
			'String','Recluster','CallBack','ReCluster');
else
	figure(CLUSTPLT);
	for ii = 1:6
		subplot(3,2,ii);cla;
    ...
    set(SYMBOLBOX,'String','o');
    set(CURRCLUSTERBOX,'String',num2str(1));
end
