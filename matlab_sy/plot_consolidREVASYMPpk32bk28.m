...
%         axtmcourse(ii)=subplot(1,bsln,ii);
        plotrawlearning2(avls,ps,startind);
%         axis square
        axis([ -2 9 2.2 2.7])
...
ps.STIM=1;
% figure
[shiftplot,combvls]=plothistoryscatter7(sumbs,ps)
figure
ps.axsum=subplot(211)
ps.axz=subplot(212)
ps.MKPLOT=1;
[plotvls]=plotbarpre(sumbs,combvls,ps);
