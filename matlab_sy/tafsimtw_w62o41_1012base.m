cd /canary/SY/w62o41/101211_baseline
...
[avnb,t,f]=get_avn('batch.catch.keep','b',0.2,0.2,'','','obs0'); 
...
%check out template
uievtafsim('batch.catch.keep',templab);
...
mk_tempf('batch.catch.keep',templab,2,'obs0');
...
get_trigt2('batch.catch.keep',cntrng,0.4,128,1,1);
...
[vals,trigs]=triglabel('batch.catch.keep','b',1,1,0,1);
