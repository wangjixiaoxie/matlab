cd /canary/SY/w62o41/1019_ClickWN
...
templaB=mean(avnB(1:2:256,[68:70]),2);
...
mk_tempf('batch.catch',templaB,2,'obs0');
...
get_trigt2('batch.catch',cntrng,0.4,128,1,1); %0.4 = refractory period (sec)
...
wrt_templ('w62o41_temp1020.dat',templaB);
