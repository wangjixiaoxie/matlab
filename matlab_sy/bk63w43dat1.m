...
catchvl{13}='batch08comb';tmn{13}=['7'];tmf{13}=['11:10'];
...
catchvl{16}='batch09.keep';tmn{16}=['7'];tmf{16}=['9:55'];
...
catchvl{34}='batch25';tmn{34}=['14:00'];tmf{34}=['21'];

pathvl{35}='/oriole/bk63w43/wnon1205newtemp/'
catchvl{35}='batch07';tmn{35}=['7'];tmf{35}=['21'];

pathvl{36}='/oriole/bk63w43/exp2_wnon526/'
catchvl{36}='batch27';tmn{36}=['7'];tmf{36}=['21'];

pathvl{37}='/oriole/bk63w43/wnoff/'
catchvl{37}='batch11.rand.keep';tmn{37}=['7'];tmf{37}=['21'];
...
acon=[ 1 3 4 6 7 9 10 12 13 15 16 18 19 21 22 24 25 27 28 29 31 32 34:37]  ;  
