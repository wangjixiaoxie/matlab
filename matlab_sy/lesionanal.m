function [outvls]=lesionplot3(prevls)
figure
figstoplot=1
daystoplot=[1 2 3  ]
postanaldy=3;
...
if(ismember(3,figstoplot))
    ps.ax=subplot(243);
    plot(preshift.cv_vals,preshift.vals,'ko','MarkerSize',4,'MarkerFaceColor','k')
    hold on;
    plot(postshift.cv_vals,postshift.vals,'ro','MarkerSize',4,'MarkerFaceColor','r')
    axis square
    axis([0 0.025 -20 150])
end
