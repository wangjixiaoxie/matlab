...
avls.pvls{1}='ac20908'
avls.cvl{1}='batch10.keep2'
avls.NT{1}='z'

% avls.pvls{2}='ampoff_feb8'
% avls.cvl{2}='batch08.keep.randtst'
% avls.NT{2}='z'


avls.pvls{2}='ac250108/'
avls.cvl{2}='batchcomb2'
avls.NT{2}='z'

avls.pvls{3}='200mu20208'
avls.cvl{3}='batch.end'
avls.NT{3}='z'
