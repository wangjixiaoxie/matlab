%changed so as to take the log of each value before averaging.
%2.23.09, saved so as to output a matrix with all the smoothed oscillogram
%values.
function [avsp,t,f,avsm,sm_mat]=get_avn(bt,NT,PRETIME,POSTTIME,PRENT,POSTNT,CS,PLTIT);
