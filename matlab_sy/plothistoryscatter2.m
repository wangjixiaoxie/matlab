...
% if(~exist(colin)||colin==0)
    ...
    for colind=1:2
        for drxn=1:2
        combvls{colind}{drxn}.offz=[]
        combvls{colind}{drxn}.acshift=[];
        combvls{colind}{drxn}.mushift=[];
        combvls{colind}{drxn}.pct=[];
        combvls{colind}{drxn}.bsnm=[];
        combvls{colind}{drxn}.shnum=[];
...
%             analrevshiftinds=revind(analrevshiftinds);
        ...
        for runvl=1:3
            ...
            shiftplot(bsnm).adjtms{ii}{runvl}=crbs.adjshifttms{ii}(tminds);
...
%         figure
    ...
    [combvls,ctvl]=plotmeanhorizarrow(shiftplot(bsnm),axhor(1),colvec,combvls,ctvl,axbnds,bsnm);
    ctvl=ctvl+1;
end
% linkaxes(ax);
...
%         length(shiftplot.acshift{ii})
        ...
        if(numvls)
            for vlind=1:numvls
                ...
                if(typevl==1)
                    combvls{1}{ii}.offz=[combvls{1}{ii}.offz combdiff]
                    combvls{1}{ii}.acshift=[combvls{1}{ii}.acshift y1]
                    combvls{1}{ii}.mushift=[combvls{1}{ii}.mushift y2];
                    combvls{1}{ii}.pct=[combvls{1}{ii}.pct pct];
                elseif(typevl==2)
                    combvls{2}{ii}.offz=[combvls{2}{ii} combdiff]
                    combvls{2}{ii}.mushift=[combvls{2}{ii}.mushift y2];
                    combvls{2}{ii}.acshift=[combvls{2}{ii}.acshift y1];
                    combvls{2}{ii}.pct=[combvls{2}{ii}.pct pct];
                elseif(typevl==3)
...
function [combvls,ctvl]=plotmeanhorizarrow(shiftplot,ax, colvec,combvls,ctvl,axbnds,bsnm)
axes(ax);
hold on;
numdrxn=length(shiftplot.drxn);  
...
for ii=1:numdrxn
    ...
    for typevl=1:length(shiftplot.acshift{ii})
        ...
        if(numvls)
                ...
                if(typevl==1)
                    combvls{1}{drxnvl}.offz=[combvls{1}{drxnvl}.offz combdiff(nonaninds)]
                    combvls{1}{drxnvl}.acshift=[combvls{1}{drxnvl}.acshift y1(nonaninds)]
                    combvls{1}{drxnvl}.mushift=[combvls{1}{drxnvl}.mushift y2(nonaninds)];
                    combvls{1}{drxnvl}.pct=[combvls{1}{drxnvl}.pct pct(nonaninds)];
                     combvls{1}{drxnvl}.bsnm=[combvls{1}{drxnvl}.bsnm bsnm*ones(1,length(nonaninds))];
                     combvls{1}{drxnvl}.shnum=[combvls{1}{drxnvl}.shnum ii*ones(1,length(nonaninds))];
                elseif(typevl==2)
                     combvls{2}{drxnvl}.offz=[combvls{2}{drxnvl}.offz combdiff(nonaninds)]
                    combvls{2}{drxnvl}.acshift=[combvls{2}{drxnvl}.acshift y1(nonaninds)]
                    combvls{2}{drxnvl}.mushift=[combvls{2}{drxnvl}.mushift y2(nonaninds)];
                    combvls{2}{drxnvl}.pct=[combvls{2}{drxnvl}.pct pct(nonaninds)];
                    combvls{2}{drxnvl}.bsnm=[combvls{2}{drxnvl}.bsnm bsnm*ones(1,length(nonaninds))];
                    combvls{2}{drxnvl}.shnum=[combvls{2}{drxnvl}.shnum ii*ones(1,length(nonaninds))];
                elseif(typevl==3)
