cd /canary/SY/r87g80/1008_lowWN
...
[avnb,t,f]=get_avn('batch2.catch.keep','b',0.2,0.2,'','','obs0'); 
...
templaB=mean(avnb(1:2:256,66),2);
...
%check out template
uievtafsim('batch2.catch.keep',templaB);
...
mk_tempf('batch2.catch.keep',templaB,2,'obs0');
...
get_trigt2('batch2.catch.keep',cntrng,0.4,128,1,1);


%do a simulation of the coevsunter ranges to see where it would have triggered
get_trigt('batch2.catch.keep',cntrng,0.5,128,1,0);

%how well did this template match
[vals,trigs]=triglabel('batch2.catch.keep','b',1,1,0,1);
...
wrt_templ('r87g80_1013.dat',templaB);
