...
avls.pvls{88}='BASELINE4/temptest/'
avls.cvl{88}='batch31'
avls.NT{88}='a'
avls.del{88}=.075;
avls.NOSTIM(88)=1;

avls.pvls{89}='BASELINE4/temptest/files01/'
avls.cvl{89}='batch01'
avls.NT{89}='a'
avls.del{89}=.075;
avls.NOSTIM(89)=1;

avls.pvls{90}='BASELINE4/temptest/files02/'
avls.cvl{90}='batch02'
avls.NT{90}='a'
avls.del{90}=.075;
avls.NOSTIM(90)=1;

avls.pvls{91}='BASELINE4/stim14_90ma_60ms_75msdelB/'
avls.cvl{91}='batch.keep'
avls.NT{91}='a'
avls.del{91}=.090;
avls.NOSTIM(91)=0;

avls.pvls{92}='BASELINE4/stim14_90ma_60ms_75msdelB/'
avls.cvl{92}='batch.keep'
avls.NT{92}='a'
avls.del{92}=.090;
avls.NOSTIM(92)=0;
...
%     avls.STAN_RUNS=[1:7 13:15 17:19 23:25 27:36 39 41:52 54:56]
    avls.STAN_RUNS=[1:7 13:15 17:19 23:25 28:33 35:36 39 41:43 45 52 54:55 57:63 65:70 75 77:92]
    conbinsmid=[30]	
    conbinshi=[73:92]
