...
function [outstr]=plot_consolid1tstv3(phsumbs,bs,sumbs)
figure
...
ps.maxsd=100
% ps.tmwins{3}=[6 7]
ps.axacz=subplot(6,5,11);
ps.axlman=subplot(6,5,12:13);
ps.axmot=subplot(6,5,14:15);
ps.plotacz=0;
ps.sumax=subplot(6,5,11)

ps.xvls=[0 2.5 4.5]

% figure
[phsumdyn,phsumdynasymp,phsumdynrev]=selectdynamicruns4(phsumbs,0,0,0)
[ctinds]=plotcombdynamics5_pharm(phsumdyn,phsumbs,ps)
...
ps.tmwins{3}=[5 6]
ps.xvls=[1.5 3.5 5.5]
ps.axlman=subplot(6,5,17:18);
ps.axmot=subplot(6,5,19:20);
ps.excludebs=0;
ps.excludeshnum=0;
ps.plotacz=0;
ps.axacz=subplot(6,5,16);
ps.sumax=ps.axacz;
% figure
[phsumdyn,phsumdynasymp,phsumdynrev]=selectdynamicruns4(phsumbs,0,0,0)
[ctinds,ctindsin]=plotcombdynamics5_pharm(phsumdynasymp,phsumbs,ps)
...
% figure
[phsumdyn,phsumdynasymp,phsumdynrev]=selectdynamicruns4(phsumbs,0,0,0)
[ctinds,ctindsin]=plotcombdynamics5_pharm(phsumdynrev,phsumbs,ps)
...
if (ismember(16,figstoplot))
    clear ps
    ps.axin=subplot(6,5,21:22); 
    ps.ploterr=0
    ps.plotz=1;
    ps.flip=1;
    
     ps.plotind=2:47
    ps.plotasympind=[14 15 16 17 18]
         ps.asympvl= 3.23
      ps.plotbasind= [4 7 9 10 12 14]
%         axtmcourse(ii)=subplot(1,bsln,ii);
        plot_tmcourse2(phsumbs(2),ps);
%         axis square
        axis([ 7 15 -1 5])
%         ps.plotedge=1;
%         ps.plotedgeybnds=[2 3]
