...
stim=[1 8 9]
for i=1:3
    plot(edges/fs,norm_meanallspikes(stim(i),:),'Color',colorvec{i},'Linewidth',2)
    hold on;
...
%legend(structnames)
legend('bos', 'm10tl', 'p10tl')
legend boxoff
figure

errorbar(meanspikerat([1 2 9 3 4 7]) ,errspikerat([1 2 9 3 4 7]),'+','Linewidth',3)
box off 
set(gca,'xtick',[1:6]);
%set(gca,'xticklabel',['bos';'rev';'l  ';'m10';'p10';'m5 ';'p5 ';'m1t';'p1t';'qui']);
set(gca,'xticklabel',['bos';'rev';'m10';'m5 ';'p5 ';'p10']);
