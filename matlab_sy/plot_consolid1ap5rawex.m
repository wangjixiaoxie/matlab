...
function [phpre,stpre,plotvlsph,plotvlsst]=plot_consolid1ap5rawex(phsumbs,sumbs,bs,sts)
figure
    ...
    for ii=1:length(ps.runstoplot)
       ...
       crmuvl=avls.mulist(crind);
        ...
        if(crvl)
           ...
           plot(avls.adjvls{1}{crvl}(:,1)-floorvl,avls.adjvls{1}{crvl}(:,2)./ps.divfac,'o','MarkerSize',4,'MarkerFaceColor','none','MarkerEdgeColor','k');
           hold on;
       end
       ...
       if(crvl)
          ...
          plot(avls.rawvls{1}{crmuvl}(rwind,1)-floorvl,avls.rawvls{1}{crmuvl}(rwind,2)./ps.divfac,'o','MarkerSize',2,'MarkerFaceColor','none','MarkerEdgeColor',[1, 0.4, 0.6])
           plot(avls.adjvls{1}{crmuvl}(:,1)-floorvl,avls.adjvls{1}{crmuvl}(:,2)./ps.divfac,'o','MarkerSize',4,'MarkerFaceColor','none','MarkerEdgeColor','r');
       end
        hold on; 
    end
