...
%these are pre and post batch files for example runs.
...
avls.pvls{89}='aug21/'
avls.cvl{89}='batch21.keep'
avls.NT{89}='a'
avls.del{89}=.065

avls.pvls{90}='BASELINE4/1031/'
avls.cvl{90}='batch.keep'
avls.NT{90}='a'
avls.del{90}=.090;

avls.pvls{91}='aug20/'
avls.cvl{91}='batch20.keep'
avls.NT{91}='a'
avls.del{91}=.065

avls.pvls{92}='BASELINE4/temptest/files02/'
avls.cvl{92}='batch02'
avls.NT{92}='a'
avls.del{92}=.090
...
%     avls.conbins=[2400 2800];
    ...
    avls.basruns=[]
    avls.contanal=1
avls.contfv=[48 49 50 51]
avls.ptfv=[48 49 50 51]
avls.analfv=[1:92]
avls.catchstimfv=[]
avls.contnum=3;
