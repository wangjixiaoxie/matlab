...
sumpath='/doyale2/twarren/pu73pu3/'
...
clear pathvl vals
pathvl{1}='/doyale2/twarren/pu73pu3/syntemptest/'
catchvl{1}='batch25'
pathvl{2}='/doyale2/twarren/pu73pu3/synwnon/'
catchvl{2}='batch.keep.catch'
pathvl{3}='/doyale2/twarren/pu73pu3/synwnon/'
...
avls.fbins{1}=[3000 5000];
avls.fbins{2}=[2000 4000];
