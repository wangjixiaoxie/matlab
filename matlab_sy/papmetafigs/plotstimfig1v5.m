...
function [combvls,shiftplot,sumdata,sumdataout,sumdataex]=plotstimfig1v5(sumbs,sts)
GROUPHST=0;
BARPLOT=1;
...
if (ismember(7,figstoplot))
   ...
   if(GROUPHST) 
    ...
    elseif(BARPLOT)
        ...
        ps.ax=subplot(5,3,[3 6])
        [sumdataout]=plotgroupbar2(combvls,ps);
