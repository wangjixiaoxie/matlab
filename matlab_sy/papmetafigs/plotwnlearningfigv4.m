...
if(ismember(1,figstoplot))
   ...
   plot(vlscomb(:,1)-init_tm,vlscomb(:,2)/3000,'ko','MarkerSize',2,'MarkerFaceColor','k','MarkerEdgeColor','none');
   hold on;
   indht=find(vlscomb(:,4)>0&vlscomb(:,4)<105&(vlscomb(:,1)-init_tm>0))
   
   plot(vlscomb(indht,1)-init_tm,vlscomb(indht,2)/3000,'ko','MarkerSize',2,'MarkerFaceColor','k','MarkerEdgeColor','none');
