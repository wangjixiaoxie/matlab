...
function [sumdatabas,sumdatash,sumdatarev]=plothistoryscript2(sumbs,sts,phsumbs);
...
if(ismember(4,figstoplot))
    ...
    sumdata.MX_TM=ps.MX_TM;   
        ps.axsum=subplot(5,6,19:21)
        ps.axpct=subplot(5,6,28)
        ps.TYPE='plotsum'
        ps.NTANAL=1;
        ps.STIM=0;
        ps.calcz=1;
        ...
        [sumdatabas,sumdatash,sumdatarev]=plotgroupbar3(combvls,ps);
end
