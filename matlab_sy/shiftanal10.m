...
%      for zz=1 length(allind1)
    ...
    function [outruns, outrunsall,mxshift, drxn,asympvl,muasympdist,acasympdist]=findruns(avls,subind,ii,jj,zz,flrtmvec,contrvl,minstd,bs);
        for subindvl=1:3
                ...
                [outruns{4},outrunsall{4},asympvl,muasympdist,acasympdist]=calcasympind(avls,avls.acz(ii,:), avls.muz(ii,:),outruns{2},outrunsall{2},mxshift,bs)
...
%   and interpolate through all the gap days                      
 ...
 function [sumbs]=overalleff(sumbs)  
     ...
     function [asympind,asympindall,asympvl,muasympdist,acasympdist]=calcasympind(avls,aczvls, muzvls,ind,indall,mxshift,bs)
