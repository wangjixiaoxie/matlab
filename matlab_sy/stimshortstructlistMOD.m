...
%this is for bk48w74
sps(1).inds=[8 9]
sps(1).datbnds{1}=[0 0.008]
sps(1).datbnds{2}=[0.008 .016]
sps(1).datbnds{3}=[.03 .038]
sps(1).datbnds{4}=[.038 .046]
...
sps(2).datbnds{1}=[.05 .058]
sps(2).datbnds{2}=[.058 .066];
sps(2).stlen=[ 10]
sps(2).catch{1}=[1 ]
sps(2).catch{2}=[1 ]
sps(2).fb{1}=1
...
%bk57w35orig.              
sps(5).inds=[46:51 ]
sps(5).stlen=[15 15 15 15 15 15 ]
sps(5).datbnds{1}=[.048 .056]
sps(5).datbnds{2}=[.056 .064]
sps(5).datbnds{3}=[.064 .072]
sps(5).datbnds{4}=[.072 .080]
...
sps(6).inds=[35 ]
sps(6).stlen=[10  ]
sps(6).datbnds{1}=[.026 .034]
sps(6).datbnds{2}=[.034 .042]
sps(6).datbnds{3}=[.042 .050]
sps(6).datbnds{4}=[.050 .058]
% sps(6).datbnds{3}=[.007 .023] 
% sps(6).datbnds{4}=[.019 .035]
sps(6).catch{1}=[1 ]
sps(6).catch{2}=[1 ]
...
sps(9).datbnds{1}=[.010 .015]
sps(9).datbnds{2}=[.015 .020]
sps(9).datbnds{3}=[.020 .025] 
sps(9).datbnds{4}=[.025 .030] 
sps(9).datbnds{5}=[.030 .035] 
sps(9).datbnds{6}=[.035 .040] 
sps(9).datbnds{7}=[.040 .045] 
sps(9).datbnds{8}=[.045 .050]
sps(9).datbnds{9}=[.050 .055]
sps(9).datbnds{10}=[.055 .060]
sps(9).datbnds{11}=[.060 .065]
sps(9).datbnds{12}=[.065 .070]
sps(9).datbnds{13}=[.070 .075]
