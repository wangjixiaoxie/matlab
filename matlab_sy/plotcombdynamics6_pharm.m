...
%                     end
            ...
            %this averages values on the same day
                ...
                if(~isempty(adjtms))
                    [adjtms,acpctvl,mupctvl,aczvl,ptvl,inactvl]=adj_vls(adjtms,acpctvl,mupctvl,aczvl,ptvl,inactvl)
                end
...
function[out_tms,outacpct,outmupct,outacz,outptvl,outinactvl]=adj_vls(adjtms,acpct,mupct,inz,ptvl,inactvl)
