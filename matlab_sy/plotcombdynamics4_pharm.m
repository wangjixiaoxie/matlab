...
function [ctinds,ctindsin,meanmu,meanac]=plotcombdynamics2_pharm(sumdynin,sumbs,ps)
...
%             end
    ...
    [acvls]=interp1(adjtms,acpctvl,tm_matrix);
    [muvls]=interp1(adjtms,mupctvl,tm_matrix);
