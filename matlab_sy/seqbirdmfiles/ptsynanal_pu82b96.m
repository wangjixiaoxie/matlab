...
% catchvl{2}='batch2.keep.rand'
clear avls
avls.baspath='/oriole7/dir2/seqshift_AAF/pu82b96/'


%START OFF BY LABELING KEY DATA

%pre data=11/20
pvl{1}='firstshift/02-10_11-09'
cvl{1}='batch.rnd'

pvl{2}='firstshift/02-11_12-09'
cvl{2}='batch.rnd'
...
cvl{23}='batchnotes'
pvl{24}='secondshift/recov_051709'
cvl{24}='batch.catch.keep'
