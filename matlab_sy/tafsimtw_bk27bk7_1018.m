cd /canary/SY/bk27bk7/1021_click
%this is not click data. no click was given. 
...
[avnA,t,f]=get_avn('batch_1025.catch','a',0.2,0.2,'','','obs0'); 
...
templaA2=mean(avnA(1:2:256,64),2);
size(templaA2) %should be 128 point vector  (128 by 1)

%normalize template
templaA2(1:3)=0;

templaA2=templaA2./max(templaA2);
%check out template
uievtafsim('batch_1025.catch',templaA2);
...
mk_tempf('batch_1025.catch',templaA,2,'obs0');
...
get_trigt2('batch_1025.catch',cntrng,0.4,128,1,1); %0.4 = refractory period (sec)
...
[vals,trigs]=triglabel('batch_1025.catch','a',1,1,0,1);
...
wrt_templ('bk27bk7_temp1025.dat',templaA);
