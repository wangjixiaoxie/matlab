...
aif_outfiles={'5767.aif' '5767m10.aif' '5767p10.aif' '5767rt.aif' }



datsong=rawsong(fs*startsong:fs*endsong);
...
figure
for(i=1:length(corpshiftednormg))
        norm=corpshiftednormg{1};
        xcorrarray=xcorr(corpshiftednormg{i},norm,5000);
        subplot(4,2,i)
        plot(-5000:5000,xcorrarray)
        offsetarray(i)=find(xcorrarray==max(xcorrarray))-5000;
end
...
wavstring={'5767_2.wav' '5767m10_2.wav' '5767p10_2.wav' '5767rt_2.wav' '5767rev_2.wav' '5767jig_2.wav'}
for i=1:length(corpshiftednormg)
    %corpshiftednormg{i}=[initbuff;corpshiftednormg{i};finalbuff];
