...
aif_outfiles={'5674.aif' '5674m10.aif' '5674p10.aif' '5674p10m10.aif' }
...
wavstring={'5674.wav' '5674m10.wav' '5674p10.wav' '5674p10m10.wav' '5674rev.wav' '5674jig.wav' '5674jigcomp.wav'}
for i=1:length(corpshiftednormg)
    %corpshiftednormg{i}=[initbuff;corpshiftednormg{i};finalbuff];
