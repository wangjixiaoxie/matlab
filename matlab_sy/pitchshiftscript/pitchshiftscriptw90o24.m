...
aif_outfiles={'9024.aif' '9024m10.aif' '9024p10.aif'}
...
wavstring={'9024.wav' '9024m10.wav' '9024p10.wav' '9024rev.wav' '9024jig.wav' '9024jigcomp.wav'}
for i=1:length(corpshiftednormg)
    %corpshiftednormg{i}=[initbuff;corpshiftednormg{i};finalbuff];
...
wavstring2={'9024syll1.wav' '9024syll2.wav' '9024syll3.wav' '9024syll4.wav' '9024syll5.wav' '9024syll6.wav' '9024syll7.wav' '9024syll8.wav' '9024syll9.wav' '9024syll10.wav'}
for i=1:10
    %resample(datsyll{i},44100,44150);
    wavwrite(datsyll{i},44100,16,wavstring2{i});
end
